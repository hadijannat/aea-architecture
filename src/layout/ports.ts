...
export function resolveEdgeHandles(
  ...
  return {
    sourceHandle: override?.sourceHandle ?? edge.interactive.sourceHandle ?? fallback.source,
    targetHandle: override?.targetHandle ?? edge.interactive.targetHandle ?? fallback.target,
  }
}
