      ...
      {(claims.length > 0 || standards.length > 0) ? (
        <section className="inspector-subsection">
          ...
          <div className="inspector-tags">
            {standardIdsToBadges(node.standardIds, manifest)}
            {claimIdsToBadges(node.claimIds)}
          </div>
          {claims.length > 0 ? (
      ...
      <section className="inspector-subsection">
        ...
        <div className="inspector-grid">
          ...
          <div>
            ...
            <p>{node.standardIds.length || 'None'}</p>
          </div>
          <div>
            <strong>Claims</strong>
            <p>{node.claimIds.length || 'None'}</p>
          </div>
          <div>
            <strong>Related steps</strong>
            <p>{node.inspector.relatedStepIds.length || 'None'}</p>
          </div>
        </div>
...
function standardIdsToBadges(standardIds: string[], manifest: GraphManifest) {
...
function claimIdsToBadges(claimIds: ClaimId[]) {
